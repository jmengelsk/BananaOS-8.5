# ==============================================================================
#
# MOD_NAME="Adds Galaxy S26 Ultra features."
...
# MFContents
ADD_FROM_FW "extra" "system" "etc/mfcontents"
ADD_FROM_FW "extra" "system" "priv-app/MFContents"


# Audio Eraser
FF "AUDIO_CONFIG_MULTISOURCE_SEPARATOR" "{FastScanning_6, SourceSeparator_4, Version_1.3.0}"
ADD_FROM_FW "extra" "system" "etc/fastScanner.tflite"
ADD_FROM_FW "extra" "system" "lib64/libmediasndk.mediacore.samsung.so"
...
# WiFi
ADD_FROM_FW "extra" "system" "app/WifiIntelligence"
ADD_FROM_FW "extra" "system" "app/WifiAiService"
...
FF "COMMON_CONFIG_AI_VERSION" "$(GET_FF_VAL "extra" "COMMON_CONFIG_AI_VERSION")"
FF "COMMON_CONFIG_AWESOME_INTELLIGENCE" "$(GET_FF_VAL "extra" "COMMON_CONFIG_AWESOME_INTELLIGENCE")"
FF "GENAI_CONFIG_LLM_VERSION" "$(GET_FF_VAL "extra" "GENAI_CONFIG_LLM_VERSION")"
FF "GENAI_SUPPORT_C2PA" "TRUE"
FF "GENAI_CONFIG_FOUNDATION_MODEL" "$(GET_FF_VAL "extra" "GENAI_CONFIG_FOUNDATION_MODEL")"
...
ADD_FROM_FW "extra" "system" "lib64/libvideoframedec_jni.so"
...
ADD_FROM_FW "extra" "system" "etc/mss_v0.13.0_4ch.sorione"
ADD_FROM_FW "extra" "system" "etc/palm_classifier.tflite"
...
ADD_FROM_FW "extra" "system" "etc/ringtones_count_list.txt"
...
ADD_FROM_FW "extra" "system" "priv-app/SecSettingsIntelligence"
