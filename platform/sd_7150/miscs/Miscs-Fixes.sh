LOG_BEGIN "- Adding "ro.netflix.bsp_rev" prop with "Q7250-19133-1" in /system/system/build.prop"
sed -i "/ro.smps.gain.spk/i ro.netflix.bsp_rev=Q7250-19133-1" "$WORKSPACE/system/system/build.prop"
LOG_END
...
BPROP_FW "system" "ro.factory.model" "$(GET_PROP "vendor" "ro.product.vendor.model" "stock")"
LOG_END
