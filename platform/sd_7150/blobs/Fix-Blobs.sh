...
LOG_BEGIN "- Adding light blobs from a73xq"
ADD_FROM_FW "a73xq" "vendor" "bin/hw/vendor.samsung.hardware.light-service"
ADD_FROM_FW "a73xq" "vendor" "lib64/vendor.samsung.hardware.light-V1-ndk_platform.so"
LOG_END
